...
const PromptBox = ({isLoading, setIsLoading}) => {
  ...
  const sendPrompt = async (e) => {
    ...
    try {
      ...
      console.log("Sending prompt:", prompt); // before request
      ...
      console.log("Response from backend:", data); // after response
      ...
      if(data.success){
        ...
        for(let i=0; i<messageTokens.length; i++){
          setTimeout(() => {
    const contentSlice = messageTokens.slice(0, i + 1).join(" ");
    setSelectedChat((prev) => {
